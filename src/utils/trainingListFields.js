export const TRAINING_LIST_FIELDS = [
  ...
  "exerciseDurations.preparationSeconds",
  "totalVolume",
  "volumeBreakdown",
...
export const SESSION_HISTORY_FIELDS = [
  ...
  "volumeBreakdown.completedSets",
  "volumeBreakdown.externalKg",
  "volumeBreakdown.machineKg",
  "volumeBreakdown.unknownKg",
  "volumeBreakdown.bodyweightSets",
  "volumeBreakdown.assistedSets",
  "volumeBreakdown.machineSets",
  "volumeBreakdown.cardioSets",
  "volumeBreakdown.unknownSets",
  "branch",
  "routineBranch",
  "sessionType",
  "supervisedBy",
