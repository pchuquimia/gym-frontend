  ...
  return (
    ...
    >
      ...
      <div className={compact ? "relative" : "relative max-w-md"}>
        <span className="mx-auto grid h-12 w-12 place-items-center border border-[#181918]/30 bg-white text-[#181918] dark:border-[#e2ff00]/30 dark:bg-black/20 dark:text-[#e2ff00]">
