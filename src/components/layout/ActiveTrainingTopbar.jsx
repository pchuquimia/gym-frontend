...
function ActiveTrainingTopbar({ training, onReturn }) {
  ...
  return (
    ...
    >
      ...
      >
        <span className="grid h-10 w-10 shrink-0 place-items-center rounded-xl border border-[color:var(--border)] bg-[color:var(--card)] text-[#181918] shadow-sm dark:text-[#e2ff00]">
          <Timer className="h-4 w-4" />
        </span>
        <span className="min-w-0 flex-1">
          <span className="block font-condensed text-[10px] font-black uppercase tracking-[0.14em] text-[#181918] dark:text-[#e2ff00]">
        ...
        <span className="inline-flex h-9 shrink-0 items-center gap-1 rounded-xl bg-[#181918] px-2.5 text-[10px] font-black uppercase text-white transition-colors group-hover:bg-[#2b2d2a] dark:bg-[#e2ff00] dark:text-black dark:group-hover:bg-[#cbe600]">
          Volver
      ...
      <div className="hidden min-h-[76px] items-center gap-5 bg-[color:var(--card)]/95 px-5 py-3 md:flex md:px-8">
        <span className="grid h-11 w-11 shrink-0 place-items-center rounded-full bg-[#181918] text-white dark:bg-[#e2ff00] dark:text-black">
          <Timer className="h-5 w-5" />
        </span>
        <div className="min-w-0 flex-1">
          <p className="font-condensed text-[10px] font-black uppercase tracking-[0.14em] text-[#181918] dark:text-[#e2ff00]">
            Entrenamiento en curso
          </p>
        ...
        <button
          type="button"
          onClick={onReturn}
          className="inline-flex h-10 shrink-0 items-center gap-2 rounded-md bg-[#181918] px-4 text-sm font-black text-white transition-colors hover:bg-[#2b2d2a] dark:bg-[#e2ff00] dark:text-black dark:hover:bg-[#cbe600]"
        >
