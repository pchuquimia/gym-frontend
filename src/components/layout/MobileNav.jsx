...
function MobileNav({ activePage, onNavigate }) {
  ...
  return (
    <nav className="mx-[18px] mb-[max(0.125rem,calc(env(safe-area-inset-bottom)-0.375rem))] rounded-[2rem] border border-[color:var(--mobile-nav-border)] bg-[color:var(--mobile-nav-bg)] p-1.5 shadow-[var(--mobile-nav-shadow)] backdrop-blur-[var(--mobile-nav-blur)] backdrop-saturate-[1.12] lg:hidden">
      <div
