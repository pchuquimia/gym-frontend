...
export default function TrainingCompletionPanel({
  ...
  return (
    <motion.section
      ...
      className="relative overflow-hidden border border-[#181918]/45 bg-[color:var(--card)] text-[color:var(--text)] shadow-[0_18px_45px_rgba(24,25,24,0.12)] dark:border-[#e2ff00]/45 dark:shadow-[0_18px_48px_rgba(226,255,0,0.08)]"
    >
      <motion.span
        aria-hidden="true"
        className="absolute inset-x-0 top-0 h-1 origin-left bg-[#181918] dark:bg-[#e2ff00]"
      ...
      <div className="px-4 pb-5 pt-6 sm:px-6 sm:pb-6">
        <header className="flex items-start gap-3 sm:items-center">
          <motion.span
            aria-hidden="true"
            className="grid h-14 w-14 shrink-0 place-items-center rounded-full bg-[#181918] text-white shadow-[0_8px_24px_rgba(24,25,24,0.28)] dark:bg-[#e2ff00] dark:text-black dark:shadow-[0_8px_26px_rgba(226,255,0,0.18)]"
          ...
          <div className="min-w-0 flex-1">
            <p className="font-condensed text-[11px] font-black uppercase tracking-[0.14em] text-[#181918] dark:text-[#e2ff00]">
        ...
        <div className="mt-5 grid grid-cols-2 border-y border-[color:var(--border)] sm:grid-cols-4">
          ...
          <div className="min-w-0 border-l border-[color:var(--border)] py-3 pl-3">
            <p className="font-condensed flex items-center gap-1 text-[10px] font-black uppercase text-[color:var(--text-muted)]">
              <Flame className="h-3 w-3 text-[#181918] dark:text-[#e2ff00]" />
              Calorías activas
            </p>
        ...
        <section className="mt-5" aria-labelledby="final-photo-title">
          ...
          {photoPreview ? (
            ...
            <label className="group flex min-h-32 cursor-pointer items-center gap-4 border border-dashed border-[color:var(--accent)] bg-[color:var(--accent)] px-4 py-5 text-[color:var(--accent-contrast)] transition-colors hover:bg-[color:var(--accent-hover)]">
              <span className="grid h-12 w-12 shrink-0 place-items-center border border-[#181918]/30 bg-white text-[#181918] shadow-sm dark:border-[#e2ff00]/30 dark:bg-[#111] dark:text-[#e2ff00]">
        ...
        <motion.button
          ...
          className="mt-5 flex h-14 w-full items-center justify-center gap-2 bg-[#181918] px-5 font-condensed text-xl font-black uppercase text-white shadow-[0_10px_28px_rgba(24,25,24,0.25)] transition-colors hover:bg-[#2b2d2a] disabled:cursor-wait disabled:opacity-80 dark:bg-[#e2ff00] dark:text-black dark:shadow-[0_10px_30px_rgba(226,255,0,0.16)] dark:hover:bg-[#cbe600]"
