  ...
  return (
    ...
    >
      ...
      <motion.section
        ...
        className="relative w-full max-w-sm overflow-hidden border border-[#352018]/55 bg-[#f7f7f9]/95 text-[color:var(--text)] shadow-[0_24px_70px_rgba(0,0,0,0.28)] backdrop-blur-xl dark:border-[#e2ff00]/55 dark:bg-[#121212]/95 dark:shadow-[0_24px_75px_rgba(0,0,0,0.72)]"
      >
        <motion.span
          aria-hidden="true"
        ...
        <div className="px-5 pb-5 pt-7 text-center">
          <motion.span
            aria-hidden="true"
            className="mx-auto grid h-20 w-20 place-items-center rounded-full bg-[#352018] text-white shadow-[0_12px_32px_rgba(53,32,24,0.3)] dark:bg-[#e2ff00] dark:text-black dark:shadow-[0_12px_34px_rgba(226,255,0,0.2)]"
          ...
          <p className="font-condensed mt-5 text-[11px] font-black uppercase tracking-[0.14em] text-[#352018] dark:text-[#e2ff00]">
          ...
          <motion.button
            ...
            onClick={onFinish}
            disabled={isFinalizing}
            className="mt-5 flex h-14 w-full items-center justify-center gap-2 bg-[#352018] px-4 font-condensed text-xl font-black uppercase text-white shadow-[0_10px_28px_rgba(53,32,24,0.25)] disabled:cursor-wait disabled:opacity-80 dark:bg-[#e2ff00] dark:text-black dark:shadow-[0_10px_30px_rgba(226,255,0,0.16)]"
            initial={false}
