  ...
  return (
    <div ref={containerRef} className="relative">
      <button
        ...
        className="w-full rounded-lg border border-[color:var(--border)] bg-[color:var(--card)] p-4 text-left shadow-sm transition-colors hover:border-[#181918] disabled:cursor-not-allowed disabled:opacity-60 dark:rounded-[4px] dark:hover:border-[#e2ff00]"
      >
        <div className="flex items-center justify-between">
          <div>
            {showLocation ? (
              <p className="text-xs font-semibold capitalize text-[#181918] dark:text-[#e2ff00]">
                {routine.location}
              </p>
            ) : null}
