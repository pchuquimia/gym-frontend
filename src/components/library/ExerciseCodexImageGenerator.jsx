...
export default function ExerciseCodexImageGenerator({
  ...
  return (
    <div className="space-y-4">
      <div className="border-l-4 border-[#181918] bg-[color:var(--bg)] p-3 dark:border-[#e2ff00]">
      ...
      {statusCopy ? (
        <div className="border border-[color:var(--border)] bg-[color:var(--bg)] p-3">
          <div className="flex items-start gap-3">
            {status === "processing" ? (
              <LoaderCircle className="mt-0.5 h-4 w-4 shrink-0 animate-spin text-[#181918] dark:text-[#e2ff00]" />
            ) : (
              <Clock3 className="mt-0.5 h-4 w-4 shrink-0 text-[#181918] dark:text-[#e2ff00]" />
            )}
      ...
      <details className="border border-[color:var(--border)] bg-[color:var(--bg)]">
        ...
        <div className="border-t border-[color:var(--border)] p-3">
          ...
          <textarea
            ...
            className="w-full resize-y border border-[color:var(--border)] bg-[color:var(--card)] p-3 text-sm font-semibold leading-relaxed text-[color:var(--text)] outline-none disabled:opacity-50 focus:border-[#181918] focus:ring-2 focus:ring-[#181918]/15 dark:focus:border-[#e2ff00] dark:focus:ring-[#e2ff00]/15"
          />
        </div>
      </details>
