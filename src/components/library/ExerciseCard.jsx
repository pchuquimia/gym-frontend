...
export default function ExerciseCard({
  ...
  return (
    <article className="library-exercise-card group overflow-hidden rounded border border-[color:var(--border)] border-t-2 border-t-[#181918] bg-[color:var(--card)] shadow-sm transition hover:border-[#181918] focus-within:ring-2 focus-within:ring-[#181918]/30 dark:border-t-[#e2ff00] dark:hover:border-[#e2ff00] dark:focus-within:ring-[#e2ff00]/30">
      <button
        type="button"
      ...
      >
        ...
        <div className="min-w-0 self-center font-sans">
          ...
          {isPersonal ? (
            <p className="mt-1 text-[12px] font-medium text-[#101110] dark:text-[#e2ff00]">
              Creado por ti
            </p>
          ) : null}
        </div>
      ...
      >
        ...
        >
          ...
          <div className="mt-2 flex min-w-0 items-center gap-1.5">
            ...
            <span className="truncate text-[10px] font-black uppercase text-[#181918] dark:text-[#e2ff00]">
              {category}
            </span>
          </div>
          {supportingText ? (
          ...
          {isPersonal ? (
            <p className="mt-2 inline-flex items-center gap-1 text-[10px] font-black uppercase text-[#101110] dark:text-[#e2ff00]">
        ...
        <ChevronRight className="h-5 w-5 self-center text-[#181918] transition group-hover:translate-x-0.5 dark:text-[#e2ff00]" />
      </button>
