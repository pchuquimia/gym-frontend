...
function ExerciseImageRow({ exercise, selected, onSelect }) {
  ...
  return (
    <button
      ...
      className={`grid min-h-[88px] w-full grid-cols-[80px_minmax(0,1fr)_20px] items-center gap-3 border px-2 py-2 text-left transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#181918]/30 dark:focus-visible:ring-[#e2ff00]/30 ${
        selected
          ? "border-[color:var(--accent)] bg-[color:var(--accent)] text-[color:var(--accent-contrast)]"
          : "border-[color:var(--border)] bg-[color:var(--card)] hover:border-[#181918]/60 dark:hover:border-[#e2ff00]/60"
      }`}
    >
      ...
      <div className="min-w-0">
        ...
        <span
          className={`mt-1 inline-block text-[9px] font-black uppercase ${
            selected ? "text-current" : "text-[#181918] dark:text-[#e2ff00]"
          }`}
        >
        ...
        <>
          <div className="border-l-4 border-[#181918] bg-[color:var(--card)] p-4 dark:border-[#e2ff00]">
            <div className="flex items-start gap-3">
              <UploadCloud className="mt-0.5 h-5 w-5 shrink-0 text-[#181918] dark:text-[#e2ff00]" />
              <div>
          ...
          <label className="relative block">
            ...
            <input
              ...
              className="h-12 w-full rounded border border-[color:var(--border)] bg-[color:var(--card)] pl-11 pr-4 text-base font-semibold text-[color:var(--text)] outline-none placeholder:text-[color:var(--text-muted)] focus:border-[#181918] focus:ring-2 focus:ring-[#181918]/15 dark:focus:border-[#e2ff00] dark:focus:ring-[#e2ff00]/15 sm:text-sm"
            />
          </label>
                  ...
                  {editorMode === "manual" ? (
                    <>
                      ...
                      <button
                        ...
                        className="grid min-h-28 w-full place-items-center border-2 border-dashed border-[color:var(--border)] bg-[color:var(--bg)] p-4 text-center transition hover:border-[#181918] dark:hover:border-[#e2ff00]"
                      >
                        <span>
                          <UploadCloud className="mx-auto h-6 w-6 text-[#181918] dark:text-[#e2ff00]" />
