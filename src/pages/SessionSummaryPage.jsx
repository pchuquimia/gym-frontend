            ...
            <div className="relative flex-1">
              <button
                ...
                className="
                  ...
                  bg-slate-50 px-4 py-1 text-left
                  transition hover:bg-slate-100
                  focus:outline-none focus:ring-2 focus:ring-blue-500/25
                  dark:border-slate-800 dark:bg-slate-800 dark:hover:bg-slate-700
                "
              >
                <div className="flex items-center justify-between gap-3">
                  <div className="min-w-0">
                    <p className="text-base font-semibold text-slate-900 truncate dark:text-slate-50">
                      {selectedRoutineName}
                    </p>
      ...
      "
          ...
          "
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-[220px_1fr]">
                      ...
                      <div className="md:border-r border-slate-200 dark:border-slate-800">
                    ...
                    `}
                                >
                                  <div className="flex items-start justify-between gap-2">
                                    ...
                                    <span className="shrink-0 inline-flex items-center rounded-full bg-slate-100 text-slate-700 text-[11px] px-2 py-0.5 dark:bg-slate-800 dark:text-slate-200">
                            ...
                            <div className="px-4 py-10 text-sm text-slate-500 dark:text-slate-300">
            ...
            <button
              type="button"
              className="
                h-12 w-12 rounded-2xl border border-slate-200
