    ...
    <div className="dashboard-shell mx-auto w-full max-w-md space-y-5 pb-12 text-[color:var(--text)] md:max-w-5xl xl:max-w-6xl">
      <header className="border-b border-[color:var(--border)] pb-4">
        <div className="min-w-0">
          <p className="text-[10px] font-black uppercase tracking-[0.14em] text-[#181918] dark:text-[#e2ff00]">
        ...
        <article className="border border-[color:var(--border)] bg-[color:var(--card)] p-3 sm:p-4">
          ...
          <div className="mt-2 flex items-center gap-1.5">
            {summary.changeKg != null ? (
              <ChangeIcon className="h-4 w-4 text-[#181918] dark:text-[#e2ff00]" />
            ) : null}
        ...
        >
          <label className="block">
            ...
            <input
              ...
              className="mt-1.5 h-12 w-full border border-[color:var(--border)] bg-[color:var(--bg)] px-3 text-base font-bold outline-none focus:border-[#181918] dark:focus:border-[#e2ff00]"
            />
          </label>
          <label className="block">
            <span className="text-[10px] font-black uppercase text-[color:var(--text-muted)]">
            ...
            <span className="relative mt-1.5 block">
              <input
                ...
                placeholder="Ej. 78,5"
                className="h-12 w-full border border-[color:var(--border)] bg-[color:var(--bg)] px-3 pr-12 text-xl font-black outline-none focus:border-[#181918] dark:focus:border-[#e2ff00]"
          ...
          <label className="block sm:col-span-2">
            ...
            <input
              ...
              className="mt-1.5 h-12 w-full border border-[color:var(--border)] bg-[color:var(--bg)] px-3 text-sm font-semibold outline-none focus:border-[#181918] dark:focus:border-[#e2ff00]"
            />
          </label>
          <Button
            type="submit"
        ...
        <div className="mt-4 h-72 sm:h-80">
          {isLoading ? (
            <div className="grid h-full place-items-center" role="status">
              <Loader2 className="h-7 w-7 animate-spin text-[#181918] dark:text-[#e2ff00]" />
            </div>
          ) : error ? (
            ...
            <ResponsiveLine
              ...
              colors={[theme === "dark" ? "#e2ff00" : "#181918"]}
              curve="monotoneX"
              lineWidth={3}
              pointSize={7}
              pointBorderWidth={2}
            ...
            <div className="grid h-full place-items-center border border-dashed border-[color:var(--border)] text-center">
              <div className="max-w-xs px-4">
                <Weight className="mx-auto h-7 w-7 text-[#181918] dark:text-[#e2ff00]" />
            ...
            .map((entry) => (
              ...
              >
                <span className="grid h-10 w-10 shrink-0 place-items-center border border-[color:var(--border)] bg-[color:var(--card)]">
                  <CalendarDays className="h-4 w-4 text-[#181918] dark:text-[#e2ff00]" />
                </span>
                ...
                <button
                  ...
                  className="grid h-10 w-10 place-items-center text-[color:var(--text-muted)] hover:text-[#181918] dark:hover:text-[#e2ff00]"
